...
`core/**`, `game/**`, `data/**`, `test/**`, `tools/**`, `addons/**`,
`design/**`, `reviews/**`, `.claude/**`, `.github/**`, `.githooks/**`,
`project.godot`, `export_presets.cfg`, the harness files or the documents that
state design (`RULES.md`, `SCENARIOS.md`, `ARCHITECTURE.md`, `DECISIONS.md`) is
